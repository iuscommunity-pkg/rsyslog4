...
%define name rsyslog4
%define real_name rsyslog
%define basever 4
...
Source0: http://www.rsyslog.com/files/download/%{real_name}/%{real_name}-%{version}.tar.gz
Source1: rsyslog.init
Source2: rsyslog.conf
Source3: rsyslog.sysconfig
Source4: rsyslog.log

# Addressed in upstream?
#Patch0: rsyslog-4.4.2-unlimited-select.patch

BuildRequires: zlib-devel
BuildRequires: autoconf26x automake libtool
...
Conflicts: %{real_name}-mysql < %{basever}
...
Conflicts: %{real_name}-pgsql < %{basever}
...
Provides: %{real_name}-gssapi = %{version}-%{release}
Conflicts: %{real_name}-gssapi < %{basever}
...
Provides: %{real_name}-relp = %{version}-%{release}
Conflicts: %{real_name}-relp < %{basever}
...
Provides: %{real_name}-gnutls = %{version}-%{release}
Conflicts: %{real_name}-gnutls < %{basever}
...
aclocal && autoconf2.6x && automake

%build

# We get a compile error for i?86 host with -march=i386
%ifarch %ix86
RPM_OPT_FLAGS=$(echo $RPM_OPT_FLAGS | sed 's/-march=i386/-march=i686/') 
%endif
...
%changelog
* Mon Sep 12 2011 Jeffrey Ness <jeffrey.ness@rackspace.com> - 4.8.0-1.ius
- Latest sources from upstream

* Fri Sep 2 2011 Jeffrey Ness <jeffrey.ness@rackspace.com> - 4.6.8-1.ius
- Latest sources from upstream

* Tue Jul 12 2011 Jeffrey Ness <jeffrey.ness@rackspace.com> - 4.6.7-1.ius
- Latest sources from upstream

* Fri Jun 24 2011 Jeffrey Ness <jeffrey.ness@rackspace.com> - 4.6.6-1.ius
- Latest sources from upstream

* Fri Feb 11 2011 Jeffrey Ness <jeffrey.ness@rackspace.com> - 4.6.5-2.ius
- Moving logrotate file from rsyslog to syslog to mimic Fedora
  and to resolve LP#716921

* Thu Feb 03 2011 Jeffrey Ness <jeffrey.ness@rackspace.com> - 4.6.5-1.ius
- Latest Sources from upstream, full change log:
  http://www.rsyslog.com/changelog-for-4-6-5-v4-stable
- Update Source0 to new download URL
- Added: %%{_libdir}/rsyslog/lmzlibw.so to %%files
- Removed: Patch0: rsyslog-4.4.2-unlimited-select.patch
- Added: ifarch condition to resolve compile errors:
  http://www.rsyslog.com/doc/build_from_repo.html

* Wed Feb 02 2011 Jeffrey Ness <jeffrey.ness@rackspace.com> - 4.4.2-6.ius
- Adding %%{_sysconfdir}/logrotate.d/rsyslog to %%files
- Removing %%{_sysconfdir}/logrotate.d/syslog to %%files

* Wed Apr 07 2010 BJ Dierkes <wdierkes@rackspace.com> - 4.4.2-5.ius
- Provides: syslog.  Resolves RS#269, LP#557430.
- Install logrotated file to rsyslog (not syslog)

* Thu Jan 07 2010 BJ Dierkes <wdierkes@rackspace.com> - 4.4.2-4.ius
- Remove Conflicts: syslog

* Wed Dec 16 2009 BJ Dierkes <wdierkes@rackspace.com> - 4.4.2-3.ius
- Conflicts: syslog

* Wed Dec 16 2009 BJ Dierkes <wdierkes@rackspace.com> - 4.4.2-2.ius
- Porting to IUS Community Project
- Name becomes rsyslog4
